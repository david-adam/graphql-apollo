...
class Dashboard extends Component {
  ...
  render() {
    ...
    // Data for Pie Chart
    let sum = 0;
    const productsPie = this.props.DashboardQuery.allProducts
      .map(p =>
        p.productQuantityPerOrders.reduce(
          // ['40%', '20%', '40%'],
      ...
      .map((p, i) => ({
        name: this.props.DashboardQuery.allProducts[i].name,
        quantity: p
      }))
          ...
          <Row>
            ...
            <Col md={6}>
              <Card
                ...
                content={
                  <NotificationList
                    notifications={this.props.DashboardQuery.allNotifications}
                  />
                }
              />
            </Col>
...
const DASHBOARD_QUERY = gql`
  query DashboardQuery {
    ...
    allOrders(filter: { orderCreatedAt_gte: "2018-01-01" }) {
      amount
      customerEmail
