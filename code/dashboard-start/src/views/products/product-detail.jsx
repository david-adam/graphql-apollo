    ...
    return (
      <div>
        ...
        <div className="">
          ...
          In store: <div className="">{Product.inStoreCount}</div>
        </div>
...
const ProductDetailWithGraphQL = compose(
  ...
  graphql(DELETE_PRODUCT_MUTATION, { name: "deleteProductMutation" })
)(ProductDetail);

const ProductDetailWithDelete = graphql(DELETE_PRODUCT_MUTATION)(
  ProductDetailWithGraphQL
);
